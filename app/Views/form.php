    ...
    <div class="main">
      ...
      <div class="content">
        ...
        <div class="alert alert-info">
          ...
          <span>Les champs marqués d'un <strong>*</strong> sont obligatoires. Ce
            formulaire illustre tous les types de champs disponibles dans le
            SI.</span>
        </div>
        ...
        <form onsubmit="return false;">
          ...
          <div class="form-card section-gap">
            ...
            <div class="form-grid">
              ...
              <div>
                <label class="field-label">Mot de passe temporaire
            ...
            <div class="form-grid cols-1">
              <div>
                ...
                <input
                  type="search"
                  placeholder="Nom ou matricule du tuteur…" />
              </div>
            </div>
          </div>
          ...
          <div class="form-card section-gap">
            ...
            <div class="form-grid cols-1">
              <div>
                <label class="field-label">Niveau de priorité —
                  <span id="range-label">50</span>%</label>
                ...
                <div class="field-hint">
                  0 = très basse priorité &nbsp;|&nbsp; 100 = critique
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-grid">
              <div>
                ...
                <div class="radio-group">
                  <label class="radio-option"><input type="radio" name="contrat" value="cdi" checked />
                    CDI</label>
                  <label class="radio-option"><input type="radio" name="contrat" value="cdd" />
                    CDD</label>
                  <label class="radio-option"><input type="radio" name="contrat" value="stage" />
                    Stage</label>
                  <label class="radio-option"><input type="radio" name="contrat" value="freelance" />
                    Freelance</label>
                </div>
              </div>
              <div>
                ...
                <div class="checkbox-group">
                  <label class="checkbox-option"><input type="checkbox" checked /> Gestion des
                    utilisateurs</label>
                  ...
                  <label class="checkbox-option"><input type="checkbox" checked /> Rapports &amp;
                    Analytics</label>
                </div>
              </div>
            </div>
          ...
          <div class="form-card section-gap">
            <div class="form-section-title">
              6. Informations complémentaires &amp; pièces jointes
            </div>
            <div class="form-grid cols-1">
              <div>
                <label class="field-label">Biographie / Remarques</label>
                <textarea
                  placeholder="Décrivez le profil de l'utilisateur, ses compétences, ses remarques particulières…"></textarea>
              </div>
            </div>
            <div class="form-grid">
              <div>
                ...
                <label for="file-photo" class="file-drop">
                  ...
                  <p>
                    Déposez une image ici<br /><strong>ou cliquez pour parcourir</strong>
                  </p>
              ...
              <div>
                ...
                <label for="file-docs" class="file-drop">
                  ...
                  <p>
                    Déposez vos fichiers ici<br /><strong>ou cliquez pour parcourir</strong>
                  </p>
                  <p style="margin-top: 6px; font-size: 11px">
                    PDF, DOCX — max 10 Mo
                  </p>
